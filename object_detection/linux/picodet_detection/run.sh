...
build/object_detection_demo ../../assets/models/picodetv2_relu6_coco_no_fuse ../../assets/labels/coco_label_list.txt ../../assets/models/picodetv2_relu6_coco_no_fuse/subgraph.txt ../../assets/models/picodetv2_relu6_coco_no_fuse/picodet.yml 
