...
ADB_DIR="/data/local/tmp/ssd_mobilenetv1_detection"
...
# mkdir
adb shell "cd /data/local/tmp/ && mkdir ssd_mobilenetv1_detection"
# push
adb push ./build/ssd_mobilenetv1_detection ${ADB_DIR}
