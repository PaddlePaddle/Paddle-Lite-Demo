...
public final class Logger {
  public static final int DOMAIN = 0x00201;

  public static HiLogLabel LABEL;
  private static final String DEFAULT_TAG = "HMBot_TAG";
  private static final int DEFAULT_MIN_LOG_LEVEL = HiLog.DEBUG;
  ...
  public Logger(final String tag, final String messagePrefix) {
    ...
    LABEL = new HiLogLabel(HiLog.LOG_APP, DOMAIN, "HMBot_TAG");
  }
  ...
  public boolean checkLoggable(final int logLevel) {
    return logLevel >= minLogLevel || HiLog.isLoggable(DOMAIN, tag, logLevel);
  }
  ...
  public void i(final Throwable t, final String format, final Object... args) {
    if (checkLoggable(HiLog.INFO)) {
      HiLog.info(LABEL, format, args, t);
    }
  }

  public void w(final String format, final Object... args) {
    if (checkLoggable(HiLog.WARN)) {
  ...
  public void w(final Throwable t, final String format, final Object... args) {
    if (checkLoggable(HiLog.WARN)) {
      HiLog.warn(LABEL, format, args, t);
    }
  }

  public void e(final String format, final Object... args) {
    if (checkLoggable(HiLog.ERROR)) {
  ...
  public void e(final Throwable t, final String format, final Object... args) {
    if (checkLoggable(HiLog.ERROR)) {
      HiLog.error(LABEL, format, args, t);
    }
  }
}
