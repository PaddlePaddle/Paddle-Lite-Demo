...
* 目标检测
    ...
    * 基于 [yolov5](https://paddlelite-demo.bj.bcebos.com/models/yolov5n/static.zip) 模型
...
* PP 识图
  ...
  | Android | iOS |
  | ---     | --- |
  | ![android_human_segmentation_cpu](https://paddlelite-demo.bj.bcebos.com/demo/PP_shitu/doc_img/app_interface.jpg)   | 补充中 |
