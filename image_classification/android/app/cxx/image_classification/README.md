...
1. 图像分类 Demo 位于 `Paddle-Lite-Demo/image_classification/android/app/cxx/image_classification` 目录
...
>> 还有一种 NDK 配置方法，你可以在 `image_classification/local.properties` 文件中手动完成 NDK 路径配置。
...
成功后效果如下，图一：APP 安装到手机        图二： APP 打开后的效果，会自动识别图片中的物体并标记
  ...
  | APP 图标 | APP 效果 |
  | ---     | --- |
  | ![app_pic](https://paddlelite-demo.bj.bcebos.com/demo/image_classification/docs_img/android/app_pic.jpg)    | ![app_res](https://paddlelite-demo.bj.bcebos.com/demo/image_classification/docs_img/android/app_run_res.jpg) |
