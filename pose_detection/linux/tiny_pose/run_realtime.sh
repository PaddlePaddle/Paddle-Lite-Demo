...
build/pose_detection_demo ../../assets/models/PP_TinyPose_128x96_qat_dis_nopact ../../assets/models/PP_TinyPose_128x96_qat_dis_nopact/subgraph.txt ../../assets/models/PP_TinyPose_128x96_qat_dis_nopact/infer_cfg.yml
