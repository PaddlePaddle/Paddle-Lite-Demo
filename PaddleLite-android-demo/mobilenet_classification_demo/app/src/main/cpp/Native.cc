...
#endif
/*
 * Class:     com_baidu_paddle_lite_demo_mobilenet_classification_Native
 * Method:    nativeInit
 * Signature:
 * (Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;II[F[F)J
 */
JNIEXPORT jlong JNICALL
Java_com_baidu_paddle_lite_demo_mobilenet_1classification_Native_nativeInit(
...
Java_com_baidu_paddle_lite_demo_mobilenet_1classification_Native_nativeRelease(
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_baidu_paddle_lite_demo_mobilenet_1classification_Native_nativeProcess(
