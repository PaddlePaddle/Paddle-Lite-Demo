...
* 基于视频流的人脸检测
  原始图片：![origin]((https://paddlelite-demo.bj.bcebos.com/doc/android_origin.jpg)
  用人脸检测模型检测出人脸，并将人脸用红色矩形框显示出来
  - CPU预测结果（测试环境：华为mate30pro）

    ![android_face_cpu](.(https://paddlelite-demo.bj.bcebos.com/doc/android_face_detect.jpg)
  - NPU预测结果
...
* 基于视频流的人脸关键点检测
  ...
  - CPU预测结果（测试环境：华为mate30pro）
    ...
    ![android_face_keypoints_cpu](https://paddlelite-demo.bj.bcebos.com/doc/android_face_keypoints.jpg)
  - NPU预测结果
...
* 基于视频流的人脸美妆
  ...
  - CPU预测结果（测试环境：华为mate30pro）
    ...
    ![android_face_spicify_cpu](https://paddlelite-demo.bj.bcebos.com/doc/android_face_spicify.jpg)
  - NPU预测结果

    待支持

## Demo内容介绍
主要从Java和C++两部分简要的介绍Demo每部分功能，更多详细的内容请见：![Demo使用指南](https://paddlelite-demo.bj.bcebos.com/doc/人脸关键点检测Demo简介.docx)
