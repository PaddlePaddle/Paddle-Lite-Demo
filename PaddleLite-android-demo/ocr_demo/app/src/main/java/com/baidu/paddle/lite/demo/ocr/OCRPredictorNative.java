...
public class OCRPredictorNative {
    ...
    public native long init(String detModelPath, String recModelPath, int threadNum, String cpuMode);

    public native float[] forward(long pointer, float[] buf, float[] ddims, Bitmap originalImage);
