...
public class SettingsActivity extends AppCompatPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mclPreInstalledModelDirs.add(getString(R.string.FKP_MODEL_DIR_DEFAULT));
        mclPreInstalledCPUThreadNums.add(getString(R.string.FKP_CPU_THREAD_NUM_DEFAULT));
        mclPreInstalledCPUPowerModes.add(getString(R.string.FKP_CPU_POWER_MODE_DEFAULT));
        mclPreInstalledInputWidths.add(getString(R.string.FKP_INPUT_WIDTH_DEFAULT));
        mclPreInstalledInputHeights.add(getString(R.string.FKP_INPUT_HEIGHT_DEFAULT));
        mclPreInstalledInputMeans.add(getString(R.string.FKP_INPUT_MEAN_DEFAULT));
        mclPreInstalledInputStds.add(getString(R.string.FKP_INPUT_STD_DEFAULT));
        // Setup UI components
        ...
        etMclModelDir = (EditTextPreference) findPreference(getString(R.string.FKP_MODEL_DIR_KEY));
        etMclModelDir.setTitle("Model dir (SDCard: " + Utils.getSDCardDirectory() + ")");
        etMclInputWidth = (EditTextPreference) findPreference(getString(R.string.FKP_INPUT_WIDTH_KEY));
        etMclInputHeight = (EditTextPreference) findPreference(getString(R.string.FKP_INPUT_HEIGHT_KEY));
        etMclInputMean = (EditTextPreference) findPreference(getString(R.string.FKP_INPUT_MEAN_KEY));
        etMclInputStd = (EditTextPreference) findPreference(getString(R.string.FKP_INPUT_STD_KEY));
    }
    ...
    private void reloadSettingsAndUpdateUI() {
        ...
        if (selectedModelIdx >= 0 && selectedModelIdx < mclPreInstalledModelDirs.size() && selectedModelIdx != mclSelectedModelIdx) {
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putString(getString(R.string.FKP_MODEL_DIR_KEY), mclPreInstalledModelDirs.get(selectedModelIdx));
            editor.putString(getString(R.string.FKP_CPU_THREAD_NUM_KEY), mclPreInstalledCPUThreadNums.get(selectedModelIdx));
            editor.putString(getString(R.string.FKP_CPU_POWER_MODE_KEY), mclPreInstalledCPUPowerModes.get(selectedModelIdx));
            editor.putString(getString(R.string.FKP_INPUT_WIDTH_KEY), mclPreInstalledInputWidths.get(selectedModelIdx));
            editor.putString(getString(R.string.FKP_INPUT_HEIGHT_KEY), mclPreInstalledInputHeights.get(selectedModelIdx));
            editor.putString(getString(R.string.FKP_INPUT_MEAN_KEY), mclPreInstalledInputMeans.get(selectedModelIdx));
            editor.putString(getString(R.string.FKP_INPUT_STD_KEY), mclPreInstalledInputStds.get(selectedModelIdx));
            editor.commit();
