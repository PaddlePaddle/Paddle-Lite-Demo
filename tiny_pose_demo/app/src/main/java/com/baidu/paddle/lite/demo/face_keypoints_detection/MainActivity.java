...
public class MainActivity extends Activity implements View.OnClickListener, CameraSurfaceView.OnTextureChangedListener {
    ...
    public void checkAndUpdateSettings() {
        if (SettingsActivity.checkAndUpdateSettings(this)) {
            int accelerate_opencl = 0;
            if (SettingsActivity.backend.equalsIgnoreCase("cpu")) {
                accelerate_opencl = 0;
            } else {
                accelerate_opencl = 1;
            }
            ...
            String modelDir = "models/tinypose";
            String realModelDir = cacheDir + modelDir;
            Utils.copyDirectoryFromAssets(this, modelDir, realModelDir);
