...
1. 人脸检测 Demo 位于 `Paddle-Lite-Demo/face_detection/android/app/cxx/face_detection` 目录
...
>> 还有一种 NDK 配置方法，你可以在 `face_detection/local.properties` 文件中手动完成 NDK 路径配置。
...
<p align="center"><img width="250" height="300"  src="https://paddlelite-demo.bj.bcebos.com/demo/face_detection/docs_img/app_pic.jpg"/>
<p align="center"><img width="250" height="300"  src="https://paddlelite-demo.bj.bcebos.com/demo/face_detection/docs_img/app_run_res.jpg"/></p>
 ...
 * 编译最终产物位于 `build.lite.xxx.xxx.xxx` 下的 `inference_lite_lib.xxx.xxx`
    * 替换 c++ 库
        * 头文件
          将生成的 `build.lite.android.xxx.clang/inference_lite_lib.android.xxx/cxx/include` 文件夹替换 Demo 中的 `Paddle-Lite-Demo/face_detection/android/cxx/face_detection/app/PaddleLite/cxx/include`
        * armeabi-v7a
          将生成的 `build.lite.android.armv7.clang/inference_lite_lib.android.armv7/cxx/libs/libpaddle_lite_api_shared.so` 库替换 Demo 中的 `Paddle-Lite-Demo/face_detection/android/cxx/face_detection/app/PaddleLite/cxx/libs/armeabi-v7a/libpaddle_lite_api_shared.so`
        * arm64-v8a
          将生成的 `build.lite.android.armv8.clang/inference_lite_lib.android.armv8/cxx/libs/libpaddle_lite_api_shared.so` 库替换 Demo 中的 `Paddle-Lite-Demo/face_detection/android/cxx/face_detection/app/PaddleLite/cxx/libs/arm64-v8a/libpaddle_lite_api_shared.so`
...
* 模型存放，将下载好的模型解压存放在 `app/src/main/assets/models` 目录下
* common Java 包
...
-  如果更新模型的输入/输出 Tensor 个数、shape 和 Dtype 发生更新，需要更新文件 `face_detection/app/src/main/cpp/Pipeline.cc` 的 `Detector::Preprocess` 预处理和 `Detector::Postprocess` 后处理代码即可。
